...
public class FragmentTaskWork extends Fragment implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    public static FragmentTaskWork newInstance() {
        return new FragmentTaskWork();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mTaskWorkData = mTaskWorkViewModel.getTasksWork(getResources().getString(R.string.work_task_fragment)
